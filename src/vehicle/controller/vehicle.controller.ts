...
export class VehicleController {
    ...
    @Post()
    async createVehicle(@Body() vehicle: CreateVehicleDto): Promise<CreateVehicleResponseDto> {
    ...
    async getVehiclesByType(@Param('typeVehicle') type: string): Promise<VehicleEntity[]> {
